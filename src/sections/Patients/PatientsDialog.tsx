...
import { Calendar, FileText, MapPin, Phone, Plus, Printer, Save, User, X } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <ScrollLockWrapper className="flex-1 overflow-y-auto pr-1 no-scrollbar">
          <form id="patientForm" onSubmit={handleSubmit} className="space-y-6 py-2" autoComplete="off">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  <Flatpickr
                    ...
                    className={cn(
                      "w-full h-12 bg-input-background border border-border rounded-xl px-4 pr-12 text-right transition-all outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 text-base md:text-sm font-bold",

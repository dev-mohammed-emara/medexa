  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden" dir="rtl">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-destructive/10 rounded-full blur-[120px] will-change-transform" />
      ...
      <section className="relative z-10 max-w-lg w-full text-center">
        ...
        <header className="space-y-4 mb-10">
          <h1 className="text-4xl font-extrabold text-[#1a2b3c] tracking-tight">وصول غير مصرح به</h1>
          <p className="text-lg text-muted-foreground max-w-md mx-auto">
            عذراً، هذه الصفحة محمية ولا يمكن الوصول إليها إلا بعد تسجيل الدخول كمسؤول للنظام.
          </p>
        </header>
        ...
        <footer className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <TransitionLink
            href="/admin/login"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-[#0B5A8E] to-[#3FB8AF] text-white rounded-xl font-bold shadow-lg shadow-[#0B5A8E]/20 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 active:translate-y-0 will-change-transform"
          >

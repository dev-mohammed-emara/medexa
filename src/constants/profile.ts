...
export const profileTranslations = {
  ar: {
    profile: {
      ...
      doctor_name_val: "د. أحمد علي الحشايكة",
      ...
      change_password_desc: "يرجى إدخال كلمة المرور الحالية وكلمة المرور الجديدة لتحديث أمان حسابك.",
  ...
  en: {
    profile: {
      ...
      change_password_desc: "Please enter your current password and a new password to update your account security.",

...
type BroadcastEvent = 
  ...
  | { type: 'APPOINTMENTS_UPDATE'; appointments: Array<{ id: string | number; date: string; time: string; patientName: string; doctorName: string; status: string; [key: string]: any }> };
